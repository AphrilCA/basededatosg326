...
CHECK (venta > 0.0),
representante_id_jefe INT NULL  --Foregin ley recursiva o jerarquica
CONSTRAINT fk_representante_representante
FOREIGN KEY (representante_id_jefe)
REFERENCES representante (representante_id),
oficina_id INT NOT NULL,  --Foregin key de oficina
created_at DATETIME2 NOT NULL  --  DATETIME2 HORA, MINUTOS Y SEGUNDOS 
CONSTRAINT df_representante_create_at
DEFAULT SYSDATETIME (),  -- SYSDATETIME ES LA FECHA Y HORA DEL SISTEMA DEL CONTENEDOR 
...
-- TIENE TODAS LAS RESTRICCIONES ABAJO, LA OTRA ES DE OTRA FORMA
/*===================CREAR TABLA OFICINA=====================*/
...
/*===================AGREGAR LOS CAMPOS DE LA AUDITORIA A PRODUCTOS=====================*/
...
DEFAULT GETDATE (), --obtiene la fecha actual
created_at DATETIME2 NOT NULL
